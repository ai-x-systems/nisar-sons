  ...
  return (
    <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <div className="flex items-center gap-3">
        <span className="font-mono text-[11px] tracking-widest2 uppercase text-brand-dark bg-brand/10 px-2.5 py-1 rounded">
          Dormer
        </span>
        <span className="text-graphite-light/40 text-[12px]" aria-hidden="true">|</span>
      ...
      <div className="flex items-center gap-2 mt-5">
        <CheckCircle2 className="w-5 h-5 text-brand-dark" strokeWidth={2} aria-hidden="true" />
      ...
      <div className="flex flex-wrap gap-3 mt-8">
        ...
        <Button
          ...
          variant="outline"
          size="lg"
          className="border-[#25D366]/50 text-brand-dark hover:bg-[#25D366] hover:text-charcoal hover:border-[#25D366]"
        >
        ...
        <Button
          href="mailto:sales@nisarsons.com?subject=Catalogue%20Request%20—%20Dormer%20A100%20Drill%20Bit"
          variant="ghost"
          size="lg"
