    ...
    <section id="specifications" className="py-20 bg-white">
      <div className="container grid lg:grid-cols-5 gap-14">
        ...
        >
          ...
          <h2 className="font-display text-2xl font-semibold text-charcoal mt-3 leading-tight tracking-tight">
            ...
            <table className="w-full text-left">
              <tbody>
                {SPECS.map(([label, value], i) => (
                  <tr
                    key={label}
                    className={i % 2 === 0 ? "bg-fog" : "bg-white"}
                  >
                    <th
                      scope="row"
                      className="w-[42%] sm:w-[36%] px-5 py-3.5 font-mono text-[11.5px] tracking-wide uppercase text-graphite-light font-medium align-top"
                    >
                      {label}
                    </th>
                    <td className="px-5 py-3.5 text-[13.5px] text-charcoal font-medium">
                      {value}
                    </td>
                  </tr>
                ))}
