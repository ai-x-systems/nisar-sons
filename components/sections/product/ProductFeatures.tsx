...
export default function ProductFeatures() {
  return (
    <section className="py-20 bg-charcoal relative overflow-hidden">
      <div className="absolute inset-0 bg-blueprint bg-grid opacity-[0.06]" />
      <div className="container relative">
        <p className="eyebrow text-brand-bright">Built In</p>
        <h2 className="font-display text-2xl sm:text-[1.75rem] font-semibold text-white mt-3 leading-tight tracking-tight max-w-xl">
          Features
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              <h3 className="font-display text-[15.5px] font-semibold text-white mt-5">
                {f.title}
              </h3>
